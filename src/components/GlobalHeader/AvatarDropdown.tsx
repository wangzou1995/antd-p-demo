...
class AvatarDropdown extends React.Component<GlobalHeaderRightProps> {
  ...
  render(): React.ReactNode {
    const { currentUser = { loginname: '' }, menu } = this.props;
    ...
    const menuHeaderDropdown = (
      <Menu className={styles.menu} selectedKeys={[]} onClick={this.onMenuClick}>
        ...
        {/*  </Menu.Item>*/}
        {/*)}*/}
        {menu && <Menu.Item key="resetPassword">
          <Icon type="edit" />
          <FormattedMessage id="menu.account.resetPassword" defaultMessage="resetPassword" />
        </Menu.Item>}
        {menu && <Menu.Divider />}
...
export default connect(({ merchantUser }: ConnectState) => ({
